function [T_b,TF_d,TF_s,TF_b,y_out,timespan_Tb] = Generate_Target_ts(TF,Logic_Output,Y0,timespan,windowSize,...
    ...
    n,k,tau,Normalize_Input_Flag,shift_1,shift_2,Noise_Level)
...
[T_b,TF_d,TF_s,TF_b,y_out,timespan_Tb]= Convert_Binary2Analog(TF,Logic_Output,Y0,timespan,windowSize,...
    Range_divider_thr,Use_Smoothed_Curve,Anti_Log,plot_ts_flag,Plot_Hill_Mesh_Flag,Use_Hill_Flag,normalized_hill_flag,n,k,tau,shift_1,shift_2,Noise_Level);
