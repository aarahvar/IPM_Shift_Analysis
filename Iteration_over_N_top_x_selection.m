...
hold on
semilogx(N_vec,mean(Detection_rate2))
semilogx(N_vec,mean(Detection_rate3))
semilogx(N_vec,mean(Detection_rate4))
semilogx(N_vec,mean(Detection_rate5))
legend('top-1','top-2','top-3','top-4','top-5')
title(['Discritization Error rate = ' num2str(Error_Rate_Binary*100,2) '%'])
xlabel('#Sample')
