function [Entropy,Sorted_Entropy,Sorted_Shift_Index,Detected_Output_Over_Shift,Remove_Index,Sorted_Cnt_0_1]=Find_Gate_Entropy_Min(TF_b,T_b,max_shift,Remove_percent,Flag_1D)
...
if Flag_1D
    ...
    [Entropy,Sorted_Entropy,Sorted_Shift_Index,Detected_Output_Over_Shift,Remove_Index,Sorted_Cnt_0_1]=Find_Entropy_Double_Shift(max_shift,TF_b,T_b,Remove_percent);
end
