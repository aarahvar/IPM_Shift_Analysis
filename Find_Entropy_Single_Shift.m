function [Entropy,Sorted_Entropy,Sorted_Shift_Index,Detected_Output_Over_Shift,Remove_Index]=Find_Entropy_Single_Shift(max_shift,TF_b,T_b,Remove_percent)
...
for shift_Detect = 0:max_shift
    ...
    %Calculate entropy
    [Entropy(shift_Detect+1),Remove_Index(shift_Detect+1).index] = Find_Entropy_01(Cnt_0_1,P_0_1,Remove_percent);
...
Remove_Index = Remove_Index(Sorted_Entropy_indx);
