function [Entropy,Sorted_Entropy,Sorted_Shift_Index,Detected_Output_Over_Shift,Remove_Index]=Find_Entropy_Double_Shift(max_shift,TF_b,T_b,Remove_percent)
