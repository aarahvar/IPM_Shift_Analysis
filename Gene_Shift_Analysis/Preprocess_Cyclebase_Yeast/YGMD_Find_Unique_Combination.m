...
[~, ~, TFcopS(2).TF] = xlsread('C:\Users\Amir\MATLAB\Shift_Analysis\Gene_Shift_Analysis\Preprocess_Cyclebase_Yeast\YGMD_TFB&TFR-Full.xlsx','2');
[~, ~, TFcopS(3).TF] = xlsread('C:\Users\Amir\MATLAB\Shift_Analysis\Gene_Shift_Analysis\Preprocess_Cyclebase_Yeast\YGMD_TFB&TFR-Full.xlsx','3');
[~, ~, TFcopS(4).TF] = xlsread('C:\Users\Amir\MATLAB\Shift_Analysis\Gene_Shift_Analysis\Preprocess_Cyclebase_Yeast\YGMD_TFB&TFR-Full.xlsx','4');
[~, ~, TFcopS(5).TF] = xlsread('C:\Users\Amir\MATLAB\Shift_Analysis\Gene_Shift_Analysis\Preprocess_Cyclebase_Yeast\YGMD_TFB&TFR-Full.xlsx','5');
...
%Find the rows that are repetitive
